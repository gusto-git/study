...
insert into snack values(snack_seq.nextval, '꼬북칩', '오리온', 2200, sysdate);
select * from snack;

insert into snack values(
snack_seq.nextval, '오예스', '크라운', 4000, to_date('2023-01-01 23','YYYY-MM-DD HH24'));
insert into snack values(
snack_seq.nextval, '맛동산', '크라운', 2500, to_date('2023-02-06 01','YYYY-MM-DD HH24'));
insert into snack values(
snack_seq.nextval, '초코파이', '오리온', 4200, to_date('2023-03-15 07','YYYY-MM-DD HH24'));
insert into snack values(
snack_seq.nextval, '고래밥', '크라운', 1900, to_date('2023-04-07 12','YYYY-MM-DD HH24'));
insert into snack values(
snack_seq.nextval, '몽쉘', '롯데', 4800, to_date('2023-06-28 16','YYYY-MM-DD HH24'));
insert into snack values(
snack_seq.nextval, '썬칩', '오리온', 1800, to_date('2023-07-07 16','YYYY-MM-DD HH24'));
insert into snack values(
snack_seq.nextval, '프링글스', '켈로그', 2700, to_date('2023-10-01 01','YYYY-MM-DD HH24'));
insert into snack values(
snack_seq.nextval, '엄마손파이', '롯데', 3900, to_date('2023-11-02 19','YYYY-MM-DD HH24'));
insert into snack values(
snack_seq.nextval, '꼬북칩', '크라운', 1800, to_date('2023-12-31 23','YYYY-MM-DD HH24'));
insert into snack values(
snack_seq.nextval, '새콤달콤', '크라운', 500, to_date('2023-02-01 01','YYYY-MM-DD HH24'));


-- 특정 시간 / 날짜
-- 내장함수 : to_date('값', '패턴')
-- 패턴(대문자!) - YYYY, MM , DD , AM/PM, HH(12시간), HH24(추천), MI , SS
insert into snack values (snack_seq.nextval, '꼬북칩', '오리온', 1900, sysdate);
...
select to_char(sysdate, 'HH') || '시' 시 , to_char(sysdate, 'MI') || '분' 분 from dual;
...
--		INSTR(s1, s2, n, k) : s1의 n번째부터 시작해서 찾고자하는 s2가 k번째 나타내는 문자열의 위치를 반환
...
--		RPAD(s, n, c) : 문자열 s의 오른쪽부터 지정한 자릿수 n까지 지정한 문자 c로 채움
...
-- 맛동산의 가격 조회
select s_price from snack where s_name = '맛동산';
-- 크라운 회사의 과자 가격 총합의 조회
select sum(s_price) from snack where s_maker = '크라운';
...
-- 연속되지 않은 값을 받아 올때 효율적으로 연산 가능
-- 결과에 반대되는 결과 값을 받아오고 싶다면 ? -> NOT 연산자
